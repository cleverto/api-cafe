...
<body>
  <div class="container">
    ...
    <div class="header">
      <small>REPORTE ESCALAFONARIO Nº13 <?= date("Y") ?></small>
    </div>
      ...
      <div class="box">
        <div class="section-container">
          <table>
            ...
            <tr>
              <td><strong>Dedicacion</strong></td>
              <td>:</td>
              <td><?= isset($lista_vinculo) ? $lista_vinculo["dedicacion"] : "" ?></td>
            </tr>
            <tr>
              <td><strong>Resolución de nombramiento</strong></td>
              <td>:</td>
              <td><?= isset($lista_vinculo) ? $lista_vinculo["nro_resolucion"] : "" ?></td>
            </tr>
            <tr>
              <td><strong>Fecha de nombramiento</strong></td>
              <td>:</td>
            ...
            <tr>
              ...
              <td>:</td>
              <td><?= isset($lista_vinculo) ? $lista_vinculo["carrera"] : "" ?></td>
            </tr>
                        <tr>
              <td><strong>Departamento académico</strong></td>
              <td>:</td>
        ...
        <table>
          <tr>
            <th colspan="3" style="text-align: center">CARGOS ADMINISTRATIVOS</th>
          </tr>
        </table>
